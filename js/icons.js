...
const Icons = {
  ...
  handshake: (size = 18, color = 'currentColor') => `
    <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="m11 17 2 2a1 1 0 0 0 1.4 0l6.6-6.6a2 2 0 0 0 0-2.8l-3.2-3.2a2 2 0 0 0-2.8 0L13 8.4"></path>
      <path d="m13 8.4-4.8 4.8a2 2 0 0 1-2.8 0L2.2 10a2 2 0 0 1 0-2.8l3.2-3.2a2 2 0 0 1 2.8 0L11 6.8"></path>
